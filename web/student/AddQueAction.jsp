...
<html>
  ...
  <body>
    ...
    if(status > 0)
    {
    	response.sendRedirect("AddQue1.jsp?msg=question added successfully...&status=1");
    }
    
    else
    {
    response.sendRedirect("AddQue1.jsp?msg=error in adding question...&status=0");
    }
    }
    else
    {
    	response.sendRedirect("AddQue1.jsp?msg=question already exists...&status=0");
    }
