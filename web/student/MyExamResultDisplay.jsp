      ...
      <div class="g-section g-tpl-230">
        ...
        <div class="g-unit" id="gc-pagecontent">
         <!-- <h1 class="page_title" style="margin: 0px !important">Hello I am Raxit - Developer of this site</h1>-->
          ...
          <div id="search">
		<form action="MyExamResultAction2.jsp" method="post">
		...
		<input type="submit" value="search" style="height: 25px ; width: 80px; background-color: #ebf4fb;elevation: 1 ">
...
<display:table  id="data" name="sessionScope.data"  pagesize="10" export="true" sort="list" defaultorder="descending" defaultsort="1">
	<display:caption><h3>UserMarks</h3></display:caption>
