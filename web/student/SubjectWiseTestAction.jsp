...
<html>
  <head>
    ...
    <title>Subject Wisetest Action</title>
  ...
  <body>
    <% 
    	int n=15;
     	String department = request.getParameter("department");
   		...
   		student.setAttribute("quizchapter","0");
    ...
    Query q = sess.createQuery("From QuestionPOJO where department = :d and subject = :s and donation =:don");
    ...
    
    {
    	...
    	response.sendRedirect("SubjectQuiz.jsp");
