  ...
  <div id="gc-header">
      ...
      <div class="g-section g-tpl-230">
        ...
        <div class="g-unit" id="gc-pagecontent">
         <!-- <h1 class="page_title" style="margin: 0px !important">Hello I am Raxit - Developer of this site</h1>-->
          ...
          <form action="AptitudeQueAddAction.jsp" method="post">
          
           <center><h1>Aptitude Que Add Form<br/><br/><br/><br/></h1></center>
    ...
    <input type="submit"   value="Add" class="large button black"  style="margin-left: 90px"/>
     ...
     <div class="spacer"></div>
		...
		<center><a href="AddQue1.jsp">@click here to donate question in Subjects section</a></center>
