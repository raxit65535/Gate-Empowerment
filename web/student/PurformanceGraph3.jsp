...
<div class="gbh" style="right: 0px;"></div>
  ...
  <div id="gc-header">
	...
	<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
          ...
          <a href="PurformanceGraphSubject1.jsp"> <button  class="small button orange" style="height: 30px ; width: 200px; background-color: #ebf4fb ">Subject</button></a> <br/><br/>
          <a href="PurformanceGraphChapter1.jsp"> <button  class="small button orange" style="height: 30px ; width: 200px; background-color: #ebf4fb ">Chapter</button></a> <br/><br/>
          <a href="PurformanceGraphAptitude1.jsp"> <button  class="small button orange" style="height: 30px ; width: 200px; background-color: #ebf4fb ">Aptitude</button></a> <br/><br/>
