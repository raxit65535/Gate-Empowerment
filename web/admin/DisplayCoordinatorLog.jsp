...
<div class="gbh" style="right: 0px;"></div>
  ...
  <div id="gc-header">
	...
	<display:table  id="data" name="sessionScope.data"  pagesize="10" export="true" sort="list" defaultsort="1" defaultorder="descending" >
	<display:caption><h3>Coordinator Log</h3></display:caption>
    ...
    <display:setProperty name="export.excel.filename" value="CoordinatorLogDetails.xls"/>
    <display:setProperty name="export.pdf.filename" value="CoordinatorLogDetails.pdf"/>
