...
<%
	...
	String department =(String)admin.getAttribute("purofrmancedepartment"); 
	
	if(department == null)
	{
		response.sendRedirect("PurformanceGraph1.jsp");
	}
  ...
  <div id="gc-header">
	...
	<br/><br/><br/><br/><br/><br/><br/>
          <center>
           ...
           <a href="PurformanceGraphSubject2.jsp" class="small button orange" style="height: 20px ; width: 200px; background-color: #ebf4fb "><font color="black">Subject</font></a> <br/><br/>
 		    <a href="PurformanceGraphChapter2.jsp" class="small button orange" style="height: 20px ; width: 200px; background-color: #ebf4fb "><font color="black">Chapter</font></a> <br/><br/>
 		    <a href="PurformanceGraphAptitude2.jsp" class="small button orange" style="height: 20px ; width: 200px; background-color: #ebf4fb "><font color="black">Aptitude</font></a> <br/><br/>         
