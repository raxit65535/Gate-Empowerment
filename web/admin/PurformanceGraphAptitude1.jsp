...
<div class="gbh" style="right: 0px;"></div>
  ...
  <div id="gc-header">
        ...
        <div class="g-unit" id="gc-pagecontent">
         <!-- <h1 class="page_title" style="margin: 0px !important">Hello I am Raxit - Developer of this site</h1>-->
          ...
          <form action="PurformaceGraphAction.jsp" method="post" target="_blank">
           ...
           <center><p>Note : this for will give result in google graph formate. It will show the result of student obtained in specific Aptitude Chapter </p></center>
    ...
    <label>Chapter      
	   <span class="small">select aptitude chapter</span></label>
	   <select name="chapter" id="chapter" required = "required">
			...
			while(it.hasNext())
			{
				AptitudeChaptersPOJO sbj = (AptitudeChaptersPOJO)it.next();
			    String chap = sbj.getChapter();
	   ...
	   <select name="student" id="student" required = "required">
		...
		<input type="hidden" id="graph" name="graph" value="Aptitude">
