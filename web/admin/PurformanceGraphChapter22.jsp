  ...
  <div id="gc-header">
        ...
        <div class="g-unit" id="gc-pagecontent">
         <!-- <h1 class="page_title" style="margin: 0px !important">Hello I am Raxit - Developer of this site</h1>-->
          ...
          <center><h2 style="background-color: #ebf4fb">Step-2</h2></center>  
           <center><p>Note : this for will give result in google graph formate. It will show the purformance graph specific Chapter.Here in step-1 select subject and in step-2 select the chapter.</p></center>
    ...
    <label>Chapter      
	   ...
	   <select name="chapter" id="chapter" required = "required">
		...
		<input type="hidden" id="graph" name="graph" value="chapter2">
