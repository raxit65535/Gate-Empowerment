...
<div class="gbh" style="right: 0px;"></div>
  ...
  <div id="gc-header">
    ...
    <div id="codesiteContent">
	 ...
	 <div id="search">
		<form action="ViewCoordinatorAction2.jsp">
		<select name="search" style="padding:4px 2px; border:solid 1px #aacfe4;" required = "required">
			<option value="..."   >...</option>
	...
	<display:table  id="data" name="sessionScope.data"  pagesize="10" sort="list" defaultsort="1" defaultorder="descending"  export="true">
	<display:caption><h3>Coordinator</h3></display:caption>
	...
	<display:column  title="ChangePasswd"  sortable="true" media="html"><a href="EditCoordinatorPasswd.jsp?${data.id}">ChangePasswd</a> </display:column>
	<display:column  title="Delete"  sortable="true" media="html"><a href="DeleteCoordinator.jsp?${data.id}">Delete</a> </display:column>
    <display:setProperty name="export.excel.filename" value="Coordinator.xls"/>
    <display:setProperty name="export.pdf.filename" value="Coordinator.pdf"/>
