...
<display:table  id="data" name="sessionScope.data"  pagesize="10" export="true" >
	<display:caption><h3>Aptitude Chapters</h3></display:caption>
	
	<display:column property="id" title="ID" sortable="true"/>
	<display:column property="chapter" title="Chapter" sortable="true"/>
	<display:column  title="Delete"  sortable="true" media="html"><a href="DeleteAptitudeChapter.jsp?${data.id}">delete</a> </display:column>
