...
<display:table  id="data" name="sessionScope.data"  pagesize="10" export="true" sort="list" defaultsort="1" defaultorder="descending">
	<display:caption><h3>User Logs</h3></display:caption>
    ...
    <display:setProperty name="export.excel.filename" value="UserLogDetails.xls"/>
    <display:setProperty name="export.pdf.filename" value="UserLogDetails.pdf"/>
