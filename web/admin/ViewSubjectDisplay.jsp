...
<div class="gbh" style="right: 0px;"></div>
  ...
  <div id="gc-header">
    ...
    <div id="codesiteContent">
	 ...
	 <div id="search">
		<form action="ViewSubjectAction2.jsp">
	...
	<display:caption><h3>Subjects</h3></display:caption>
    ...
    <display:column  title="Delete"  sortable="true" media="html"><a href="DeleteSubject.jsp?${data.id}">delete</a> </display:column>
    <display:setProperty name="export.excel.filename" value="SubjectDetails.xls"/>
    <display:setProperty name="export.pdf.filename" value="SubjectDetails.pdf"/>
