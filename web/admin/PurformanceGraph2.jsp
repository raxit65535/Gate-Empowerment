...
<%
 ...
 {
		admin.setAttribute("purofrmancedepartment",department);
 }
  ...
  <div id="gc-header">
	...
	<br/><br/><br/><br/><br/><br/><br/>
          <center>
           ...
           <a href="PurformanceGraph3.jsp" class="small button orange" style="height: 20px ; width: 200px; background-color: #ebf4fb "><font color="black">Student Purformance</font></a> <br/><br/>
 		    <a href="PurformanceGraph4.jsp" class="small button orange" style="height: 20px ; width: 200px; background-color: #ebf4fb "><font color="black">Over All Purformance</font></a> <br/><br/>         
