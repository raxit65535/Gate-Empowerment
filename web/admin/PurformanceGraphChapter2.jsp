      ...
      <div class="g-section g-tpl-230">
        ...
        <div class="g-unit" id="gc-pagecontent">
         <!-- <h1 class="page_title" style="margin: 0px !important">Hello I am Raxit - Developer of this site</h1>-->
          ...
          <form action="PurformanceGraphChapter22.jsp" method="post">
         
           <center><h1>Purformance Graph for Chapter Type<br/></h1></center>
         <center><h2 style="background-color: #ebf4fb">Step-1</h2></center>  
           <center><p>Note : this for will give result in google graph formate. It will show the purformance in specific Chapter.Here in step-1 select subject and in step-2 select the chapter.</p></center>
