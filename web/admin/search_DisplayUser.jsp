  ...
  <div id="gc-header">
    ...
    <div id="codesiteContent">
      ...
      <div class="g-section g-tpl-230">
		...
		<html:form action="/search_DisplayUser">
		<select name="search"  id="search" required="required"  style="padding:4px 2px; width :150; border:solid 1px #aacfe4;">
			...
			List<DepartmentPOJO> pooja = (List<DepartmentPOJO>)q.list();
	...
	<display:table  id="data" name="sessionScope.data" pagesize="10" defaultorder="descending" defaultsort="1" sort="list" export="true" >
	<display:caption><h3>User</h3></display:caption>
    ...
    <display:column  title="Delete"  sortable="true" media="html"><a href="DeleteUser.jsp?${data.id}">delete</a> </display:column>
    <display:column  title="Analitics"  sortable="true" media="html"><a href="PerformanceData.jsp?${data.email}" target="_blank">Performance</a> </display:column>   
    <display:setProperty name="export.excel.filename" value="UserDetails.xls"/>
    <display:setProperty name="export.pdf.filename" value="UserDetails.pdf"/>
