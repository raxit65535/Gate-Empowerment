...
{
	admin.setAttribute("qupdepartment",dpt);
	admin.setAttribute("qupsubject",sub);
	admin.setAttribute("qupchapter",chap);
}
 %>
...
<div class="gbh" style="right: 0px;"></div>
  ...
  <div id="gc-header">
    ...
    <center><h1>Que Upload Form<br/></h1></center>
          <center><h2 style="background-color: #ebf4fb">Step-4</h2></center>
   ...
   <center><h5>
    ...
    <input type="submit"   value="GO" class="large button black" onclick="return rax();" style="margin-left: 90px"/>
     ...
     <div class="spacer" style="margin-bottom: -230"></div>
    </div>
