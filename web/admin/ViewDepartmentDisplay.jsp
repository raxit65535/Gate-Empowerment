...
<display:table  id="data" name="sessionScope.data"  pagesize="10" export="true" >
	<display:caption><h3>Departments</h3></display:caption>
	
	<display:column property="id" title="ID" sortable="true"/>
	<display:column property="name" title="Department" sortable="true"/>
	<display:column  title="Delete"  sortable="true" media="html"><a href="DeleteDepartment.jsp?${data.id}">delete</a> </display:column>
	
    <display:setProperty name="export.excel.filename" value="departments.xls"/>
    <display:setProperty name="export.pdf.filename" value="departments.pdf"/>
