  ...
  <div id="gc-header">
        ...
        <div class="g-unit" id="gc-pagecontent">
         <!-- <h1 class="page_title" style="margin: 0px !important">Hello I am Raxit - Developer of this site</h1>-->
          ...
          <form action="PurformaceGraphAction.jsp" method="post" target="_blank">
           ...
           <center><h1>Purformance Graph for whole Subject<br/><br/><br/><br/></h1></center>
           <center><p>Note : this for will give result in google graph formate. It will show the result of whole subject </p></center>
    ...
    <label>Subject      
	   ...
	   <select name="subject" id="subject" required = "required">
		...
		<input type="hidden" id="graph" name="graph" value="subject2">
