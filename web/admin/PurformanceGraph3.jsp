  ...
  <div id="gc-header">
	...
	<br/><br/><br/><br/><br/><br/><br/>
          <center>
           ...
           <a href="PurformanceGraphSubject1.jsp" class="small button orange" style="height: 20px ; width: 200px; background-color: #ebf4fb "><font color="black">Subject</font></a> <br/><br/>
 		    <a href="PurformanceGraphChapter1.jsp" class="small button orange" style="height: 20px ; width: 200px; background-color: #ebf4fb "><font color="black">Chapter</font></a> <br/><br/>
 		    <a href="PurformanceGraphAptitude1.jsp" class="small button orange" style="height: 20px ; width: 200px; background-color: #ebf4fb "><font color="black">Aptitude</font></a> <br/><br/>         
