...
<%
   ...
   if ((contentType.indexOf("multipart/form-data") >= 0)) {
    ...
    if(number == 420)
    	{
    		response.sendRedirect("UploadQueAptitude1.jsp?msg=Your Question formate having error (ArrayIndexOutOfBound)...&status=0");
    	}
    	else if(number == 0)
    	{
    	response.sendRedirect("UploadQueAptitude1.jsp?msg=No questions uploaded...&status=0");
    	}
    	else if(number > 0)
    	{
    	response.sendRedirect("UploadQueAptitude1.jsp?msg="+number+" questions uploaded...&status=1");
    	}
         ...
         System.out.println(ex);
   			...
   			response.sendRedirect("UploadQueAptitude1.jsp?msg=fail to read file ..!!!&status=0");
