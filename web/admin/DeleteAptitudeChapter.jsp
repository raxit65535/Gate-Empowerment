...
<html>
  ...
  <body>
   <%
   		...
   		Query q = sess.createQuery("From AptitudeChaptersPOJO where id = :i");
   		q.setString("i",id);
   		List<AptitudeChaptersPOJO> heli = (List<AptitudeChaptersPOJO>)q.list();
   		t.commit();
   		//sess.close();
   		
   		for(AptitudeChaptersPOJO e : heli)
   		{
   		...
   		Query q1 = sess1.createQuery("From QuestionPOJO where department = :d and subject = :s and chapter = :c");
   		q1.setString("d",department);
   		q1.setString("s",subject);
   		q1.setString("c",chapter);
   		...
   		Query q2 = sess2.createQuery("Delete from AptitudeChaptersPOJO where id = :i");
   		q2.setString("i",id);
