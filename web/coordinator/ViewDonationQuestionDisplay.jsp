...
<div class="gbh" style="right: 0px;"></div>
  ...
  <div id="gc-header">
	...
	<display:caption><h3>Donation Question</h3></display:caption>
    ...
    <display:column  title="View"  sortable="true" media="html"><a href="viewQS.jsp?${data.id}" target="_blank">View</a> </display:column>
    <display:column  title="Accept"  sortable="true" media="html"><a href="acceptQS.jsp?${data.id}">Accept</a> </display:column>
    <display:column  title="Accept"  sortable="true" media="html"><a href="rejectQS.jsp?${data.id}">Reject</a> </display:column>
       
    <display:setProperty name="export.excel.filename" value="QuestionDetails.xls"/>
    <display:setProperty name="export.pdf.filename" value="QuestionDetails.pdf"/>
