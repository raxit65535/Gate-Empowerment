...
<div class="gbh" style="right: 0px;"></div>
  ...
  <div id="gc-header">
	...
	<display:caption><h3>Donation Material</h3></display:caption>
    ...
    <display:column  title="Accept"  sortable="true" media="html"><a href="acceptMT.jsp?${data.id}">Accept</a> </display:column>
    <display:column  title="Reject"  sortable="true" media="html"><a href="rejectMT.jsp?${data.id}">Reject</a> </display:column>
