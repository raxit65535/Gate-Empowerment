...
<html>
  ...
  <body>
    ...
    if(status > 0)
    {
    	response.sendRedirect("AddQuestion.jsp?msg=question added successfully...&status=1");
    }
    
    else
    {
    response.sendRedirect("AddQuestion.jsp?msg=error in adding question...&status=0");
    }
    }
    else
    {
    	response.sendRedirect("AddQuestion.jsp?msg=question already exists...&status=0");
    }
