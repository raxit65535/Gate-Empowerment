...
<meta name="HandheldFriendly" content="true" />
        <title>Coordinator account | U. V. Patel College of Engineering</title>
...
<li class="last leaf"><a href="http://uvpce.ac.in/new/content/contact-us-0" title="">Contact Us</a></li>
	...
	<div id="stylized" class="myform">	
		<html:form action="/coordinatorLogin">
		<center><h1>Coordinator Login</h1></center>
		...
		<input type="submit" name="submit" value="Login" style="margin-left: 90px" onclick="return b();"/>
			...
			<div class="spacer" style="margin-bottom: -270"></div>	
		</html:form>
